...
export interface AudioTrack {
  index: number; codec: string; language: string; title?: string; duration?: number;
  channels?: number; layout?: string; bitrate?: number; isDefault: boolean;
  isForced?: boolean; isCommentary: boolean; isDescriptive: boolean;
}
...
export interface Settings {
  suiteName: string; appName: string; shortName: string; accent: string; theme: 'dark' | 'light' | 'system'; showSuite: boolean;
  requiredLanguages: string[]; allowDescriptive: boolean; ignoreCommentary: boolean; requireMainProgram: boolean;
